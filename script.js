const projects=[
  ...
  {tag:"Team Hackathon · 24 hours · Infinite Computer Solution",title:"NulAware AI",
    ...
    tech:["LANGGRAPH","QWEN 2.5","CHROMADB","STREAMLIT","MCP","OLLAMA"],
    github:"https://github.com/shrinithi19/Nulaware-NL-Profiling",
    what:"NulAware replaces manual EDA. Upload a CSV, ask natural language questions and the LangGraph agent handles profiling, retrieval, and response — on Gemini with zero paid API costs.",
  ...
  {tag:"IoT + Computer Vision · 2nd Runner-Up in Tech-Vision 2026",title:"Powerloop",
    ...
    what:"Powerloop connects the physical and digital worlds. An ESP32 streams live camera feed over WiFi to a Flask backend running YOLOv8 inference via OpenCV. Detected objects render in real-time on a browser dashboard.",
  ...
  {tag:"Computer Vision · PCB QC",title:"PCB AI Inspector",
    ...
    what:"Two AI models run in parallel. DINOv2 detects whether a component matches its reference. A CNN classifier identifies solder joint defects. Both output into one Gradio interface usable without any code.",
  ...
  {tag:"Game Development",title:"Flappy Bird",
    ...
    what:"Built without any game engine — pure Pygame. Custom gravity and jump velocity physics, procedural pipe generation, pixel-perfect collision detection with hitbox masks, and a full state machine from menu to death screen.",
